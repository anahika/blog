            ...
            <div className="card cardcss">
              ...
              <div className="card-body">
                ...
                <p className="card-text">
                  The Story begins where it all started 12 years ago, Cristiano
                  Ronaldo reached an agreement with Manchester United 12 years
                  after he left Old Trafford for Real Madrid. Where it all
                  started from the rumors-Cristiano to City...
                </p>
              </div>
            </div>
          </Link>
          ...
          <Link to="/post/beauti-lies-within-special" className="custom-card">
            <div className="card cardcss">
              ...
              <div className="card-body">
                ...
                <p className="card-text">
                  Blessed you're lights. There. Behold may yielding meat can't
                  void rule, earth green have creepeth land let gathering great
                  fruitful under gathered waters...
                </p>
              </div>
            </div>
          </Link>
            ...
            <div className="card cardcss">
              ...
              <div className="card-body">
                ...
                <p className="card-text">
                  ...
                  departure elsewhere dejection at..
                </p>
              </div>
            </div>
          </Link>
          ...
          <Link to="/post/memories-from-last-summer" className="custom-card">
            <div className="card cardcss">
              ...
              <div className="card-body">
                ...
                <p className="card-text">
                  Purus Convallis nascetur diam torquent sit id adipiscing in
                  netus praesent etiam enim nec massa fusce orci nam potenti hac
                  tortor montes placerat tortor natoque ante volutpat className
                  className platea hymenaeos...
                </p>
              </div>
            </div>
          </Link>
