      ...
      <Card style={{ marginBottom: "20px", paddingBottom: "20px" }}>
        ...
        <div className="mt-3" style={{ textAlign: "center" }}>
          ...
          <p className="m-4">
            ...
            Ronaldo reached an agreement with Manchester United 12 years after
            he left Old Trafford for Real Madrid. Where it all started from the
            rumors-Cristiano to City...
          </p>
